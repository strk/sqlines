...
function(ADD_SQLINES_LIB LIB_NAME)
  set(options)
  ...
  if (SQLINES_BUILD_STATIC)
    ...
    if (MSVC)
      ...
      target_compile_definitions(${LIB_NAME}_static PUBLIC SQLINES_STATIC)
    else()
...
function(ADD_SQLINES_BENCHMARK REL_BENCHMARK_NAME)
  if(NO_BENCHMARKS)
    return()
  endif()
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${REL_BENCHMARK_NAME}.cc)
    ...
    target_link_libraries(${BENCHMARK_NAME} ${SQLINES_BENCHMARK_LINK_LIBS})
...
function(ADD_SQLINES_BENCHMARK_DEPENDENCIES REL_BENCHMARK_NAME)
  if(NO_BENCHMARKS)
    return()
  endif()
...
function(SQLINES_BENCHMARK_LINK_LIBRARIES REL_BENCHMARK_NAME)
    if(NO_BENCHMARKS)
    return()
  endif()
  get_filename_component(BENCHMARK_NAME ${REL_BENCHMARK_NAME} NAME_WE)
...
#
# Arguments after the test name will be passed to set_tests_properties().
function(ADD_SQLINES_TEST REL_TEST_NAME)
  ...
  if(NO_TESTS OR NOT SQLINES_BUILD_STATIC)
    return()
  endif()
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${REL_TEST_NAME}.cc)
    ...
    if (ARG_STATIC_LINK_LIBS)
      ...
      target_link_libraries(${TEST_NAME} ${SQLINES_TEST_LINK_LIBS})
    endif()
  ...
  if (SQLINES_TEST_MEMCHECK AND NOT ARG_NO_VALGRIND)
    SET_PROPERTY(TARGET ${TEST_NAME}
      APPEND_STRING PROPERTY
      COMPILE_FLAGS " -DSQLINES_VALGRIND")
    add_test(${TEST_NAME}
...
function(ADD_SQLINES_TEST_DEPENDENCIES REL_TEST_NAME)
  if(NO_TESTS)
    return()
  endif()
  get_filename_component(TEST_NAME ${REL_TEST_NAME} NAME_WE)
...
function(SQLINES_TEST_LINK_LIBRARIES REL_TEST_NAME)
  if(NO_TESTS)
    return()
  endif()
  get_filename_component(TEST_NAME ${REL_TEST_NAME} NAME_WE)
...
#
function(ADD_SQLINES_FUZZING REL_FUZZING_NAME)
  if(NO_FUZZING)
    return()
  endif()

  if (SQLINES_BUILD_STATIC)
    set(FUZZ_LINK_LIBS sqlines_static)
  else()
    set(FUZZ_LINK_LIBS sqlines_shared)
  endif()
