...
if (MSVC)
  # TODO: Change usages of C runtime functions that MSVC says are
  # insecure, like std::getenv
  #add_definitions(-D_CRT_SECURE_NO_WARNINGS)

  # Use __declspec(dllexport) during library build, other users of the SQLINES
  # headers will see dllimport
  add_definitions(-DSQLINES_EXPORTING)
  ...
  elseif(${CMAKE_CXX_COMPILER_VERSION} VERSION_LESS 19)
    ...
    by SQLINES. Found version ${CMAKE_CXX_COMPILER_VERSION}.")
  else()
...
if ("${UPPERCASE_BUILD_WARNING_LEVEL}" STREQUAL "CHECKIN")
  ...
  elseif ("${COMPILER_FAMILY}" STREQUAL "clang")
    set(CXX_COMMON_FLAGS "${CXX_COMMON_FLAGS} -Weverything -Winfinite-recursion -Wno-c++98-compat \
...
-Wno-disabled-macro-expansion -fcomment-block-commands=retval")
...
if (CXX_SUPPORTS_SSE3 AND SQLINES_SSE3)
  set(CXX_COMMON_FLAGS "${CXX_COMMON_FLAGS} -msse3")
endif()

if (CXX_SUPPORTS_ALTIVEC AND SQLINES_ALTIVEC)
...
#   -DSQLINES_CXXFLAGS="-g" to add them
if (NOT MSVC)
...
if ("${CMAKE_CXX_FLAGS}" MATCHES "-DNDEBUG")
  set(SQLINES_DEFINITION_FLAGS "-DNDEBUG")
else()
  set(SQLINES_DEFINITION_FLAGS "")
endif()
