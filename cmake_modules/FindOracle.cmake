...
ELSE (ORACLE_PATH_LIB)
    SET (ORACLE_LIB_LOCATION
            ...
            # instant client on OS X from Oracle Instant Client Downloads for macOS
...
IF (NOT DEFINED ORACLE_OCI_VERSION AND ORACLE_INCLUDES)
  TRY_RUN(OCIVER_TYPE OCIVER_COMPILED
    ${CMAKE_BINARY_DIR}
    ${CMAKE_MODULE_PATH}/OCIVersion.c
    CMAKE_FLAGS "-DINCLUDE_DIRECTORIES:STRING=${ORACLE_INCLUDES}"
    RUN_OUTPUT_VARIABLE OCIVER)

  MESSAGE(STATUS "OCIVER_TYPE value: '${OCIVER_TYPE}'")
  ...
  MESSAGE(STATUS "Guessed ORACLE_OCI_VERSION value: ${ORACLE_OCI_VERSION} for OCIVER_TYPE ${OCIVER_TYPE}")
...
IF (ORACLE_USE_OCCI)
    set( _oracle_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
    # The NO_DEFAULT_PATH is necessary here in the case there is Oracle DB
    # *and* instant client installed. The order is given in ORACLE_LIB_LOCATION.
    # See above.
    ...
    set(CMAKE_FIND_LIBRARY_SUFFIXES ${_oracle_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES})
